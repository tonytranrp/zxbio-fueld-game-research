...
void main(in PSInput PSIn, out PSOutput PSOut)
{
    ...
    // lin-look-log.md ยง3). One cube along the normal clears the riser; AO keeps half so contact
    ...
    // (research/tree-motion-growth-and-appearance.md ง6.2). Gust and flutter together: the gust
