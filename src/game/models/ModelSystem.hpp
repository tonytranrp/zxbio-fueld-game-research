...
#include "engine/animation/ModelKeyframe.hpp"
...
struct ModelAssetSpec {
    using KeyframeClipFactory = std::vector<::biofuel::engine::animation::model::KeyframeClip>(*)();
...
public:
    ...
    [[nodiscard]] const ::biofuel::engine::animation::model::ModelKeyframeState& keyframeState() const noexcept { return m_keyframePlayer.state(); }
