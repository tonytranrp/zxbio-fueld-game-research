...
using HandsShader = ::biofuel::engine::runtime::typed::shader::MenuHands;
namespace HandsUniforms = ::biofuel::engine::runtime::typed::shader::menu_hands;
...
void applyWeightedBoneOffsets(
    game::models::ModelInstance& instance,
...
void MenuTransitionHands::load() {
    ...
    auto instance = ::biofuel::engine::runtime::Runtime::model().createInstance(ASSET_ID);
...
void MenuTransitionHands::update(
    ...
    const ::biofuel::engine::graphics::component::ShaderCameraState& shaderCamera) noexcept
{
...
#ifdef BIOFUEL_DEV_MODEL_CONTROLLER
void MenuTransitionHands::renderControllerOverlay() noexcept {
    if (!isRendering() || !m_loaded || !m_instance) {
        return;
    }
...
MenuTransitionHands::TransitionRenderPose MenuTransitionHands::buildPose(
    const game::models::ModelInstance& instance) const noexcept
{
    const auto& keyframe = instance.keyframeState();
    const f32 shift = ::biofuel::engine::animation::Easing::easeInOutCubic(m_dimensionShift);
...
void MenuTransitionHands::drawHands(
    const game::models::ModelInstance& instance,
    const TransitionRenderPose& pose) const noexcept
{
    ...
    instance.draw(game::models::ModelRenderState{
...
void MenuTransitionHands::cacheUniformLocations(const Shader shader) const noexcept {
    ...
    m_timeLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::Time>(shader);
    m_portalStrengthLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::PortalStrength>(shader);
    m_fingerStartLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::FingerStartY>(shader);
    m_fingerEndLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::FingerEndY>(shader);
    m_colorALoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::ColorA>(shader);
    m_colorBLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::ColorB>(shader);
    m_rimColorLoc = ::biofuel::engine::runtime::typed::Shaders::loc<HandsShader, HandsUniforms::RimColor>(shader);
    m_cachedShaderId = shader.id;
}

void MenuTransitionHands::applyShaderUniforms(const game::models::ModelInstance& instance) const noexcept {
    ...
    const f32 portalStrength = std::clamp(
        instance.keyframeScalar("portal_bias", 0.18f) + ::biofuel::engine::animation::Easing::easeInOutCubic(m_dimensionShift) * 0.50f,
        0.0f,
        1.45f
    );
    ...
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::Time>(shader, m_timeLoc, &m_elapsed);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::PortalStrength>(shader, m_portalStrengthLoc, &portalStrength);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::FingerStartY>(shader, m_fingerStartLoc, &m_fingerStartY);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::FingerEndY>(shader, m_fingerEndLoc, &m_fingerEndY);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::ColorA>(shader, m_colorALoc, colorA);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::ColorB>(shader, m_colorBLoc, colorB);
    ::biofuel::engine::runtime::typed::Shaders::set<HandsShader, HandsUniforms::RimColor>(shader, m_rimColorLoc, rimColor);
}
