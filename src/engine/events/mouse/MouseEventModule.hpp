...
BIOFUEL_EVENT_TAG(Moved, ::biofuel::engine::events::mouse::MouseMovedEvent);
...
BIOFUEL_EVENT_SPEC(mouse::Moved, "mouse.moved");
...
BIOFUEL_EVENT_MODULE(MouseEventModule, InputEvents, mouse::Moved, mouse::Pressed, mouse::Released, mouse::Scrolled)
} // namespace biofuel::engine::runtime::typed
