...
public:
    ...
    void setTarget(
        ...
        f32 duration,
        ::biofuel::engine::animation::Easing::Fn easing = ::biofuel::engine::animation::Easing::easeInOutCubic) noexcept;
...
private:
    ...
    ::biofuel::engine::animation::Easing::Fn m_easing = ::biofuel::engine::animation::Easing::easeInOutCubic;
};
