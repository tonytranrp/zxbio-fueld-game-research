...
Components may use low-level `ShaderManager` helpers when they apply generic uniforms to arbitrary shaders. Shader-specific render paths should prefer typed shader modules and `Shaders::loc/set<TShader, TUniform>()`.
