...
constexpr std::array kTable{
    ...
    Option{.name = "sway-frames",
           ...
           .kind = ValueKind::Int,
           .help = "also write N side-view PNGs across one sway period (0 = off)",
           .default_text = "0",
           .group = "Sway"},
    Option{.name = "sway-png",
           .set = bind<&Options::sway_png>(),
           .kind = ValueKind::String,
           .help = "prefix for the sway PNGs",
           .default_text = "<species>_sway_<seed>",
           .group = "Sway"},
    Option{.name = "sway-size",
           .set = bind<&Options::sway_size>(),
           .kind = ValueKind::Size,
           .help = "sway frame size",
           .default_text = "640x720",
           .group = "Sway"},
    Option{.name = "wind-speed",
           .set = bind<&Options::wind_speed>(),
           .kind = ValueKind::Float,
           .help = "wind speed driving the sway, m/s",
           .default_text = "4",
           .group = "Sway"},
    Option{.name = "sway-periods",
           .set = bind<&Options::sway_periods>(),
           .kind = ValueKind::Float,
           .help = "how many fundamental periods the frame sequence spans",
           .default_text = "1",
           .group = "Sway"},
    Option{.name = "sway-settle",
           .set = bind<&Options::sway_settle_seconds>(),
           .kind = ValueKind::Float,
           .help = "seconds of wind driven from rest before the first frame",
           .default_text = "20",
           .group = "Sway"},
    Option{.name = "branch-reaction",
           .set = bind<&Options::branch_reaction>(),
           .kind = ValueKind::Toggle,
           .help = "let branches push back on what carries them (the damping-by-branching term)",
           .default_text = "on",
           .group = "Sway"},
};
